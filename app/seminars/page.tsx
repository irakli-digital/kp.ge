...
export default function SeminarsPage() {
  const seminars = [
    {
      title: "სისტემური განლაგებების რითრითი",
      description: "3 დღიანი ტრანსფორმაციული რითრითი გუდაურში, სადაც სისტემური განლაგებების, ბგერითი თერაპიისა და თვითაღმოჩენის უნიკალურ გამოცდილებას მიიღებ.",
    ...
    },
    {
      ...
      description: "6-საათიანი პრაქტიკული სემინარი, სადაც ცნობიერებასთან და მის მექანიზმებთან დაკავშირებულ საკითხებს განვიხილავთ.",
    ...
    {
      title: "ტრანსფორმაციის ვორკშოპი",
      description: "ორდღიანი ინტენსიური ვორკშოპი - როგორ გათავისუფლდე დესტრუქციული როლებისგან და შეცვალო შენი ცხოვრება.",
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg">
                გეპატიჟებით პრაქტიკულ სემინარებსა და ვორქშოპებზე, სადაც ცნობიერების,
                პიროვნული განვითარებისა და ტრანსფორმაციის თემებს განვიხილავთ.
              </p>
            </motion.div>
